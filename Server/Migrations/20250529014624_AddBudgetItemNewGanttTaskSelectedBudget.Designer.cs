...
namespace Server.Migrations
{
    ...
    [Migration("20250529014624_AddBudgetItemNewGanttTaskSelectedBudget")]
    partial class AddBudgetItemNewGanttTaskSelectedBudget
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.BudgetItemNewGanttTaskSelectedBudget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BudgetItemNewGanttTaskId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SelectedBudgetItemId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BudgetItemNewGanttTaskId");

                    b.ToTable("BudgetItemNewGanttTaskSelectedBudgets");
                });
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.BudgetItemNewGanttTaskSelectedBudget", b =>
                {
                    b.HasOne("Server.Database.Entities.BudgetItems.BudgetItemNewGanttTask", "BudgetItemNewGanttTask")
                        .WithMany("SelectedBudgetItems")
                        .HasForeignKey("BudgetItemNewGanttTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BudgetItemNewGanttTask");
                });
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.BudgetItemNewGanttTask", b =>
                {
                    b.Navigation("SelectedBudgetItems");
                });
