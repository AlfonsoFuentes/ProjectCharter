...
namespace Server.Migrations
{
    ...
    [Migration("20250712210637_RenameFL")]
    partial class RenameFL
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Nozzles.Nozzle", b =>
                {
                    ...
                    b.Property<Guid?>("BasicEngineeringItemConnectedId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BasicEngineeringItemConnectedId");
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Pipings.IsometricItem", b =>
                {
                    ...
                    b.Property<Guid>("BasicPipeItemId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.Entities.ProjectManagements.MonitoringLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.Entities.ProjectManagements.OtherTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.LineProductionSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LineProductionSchedules");
                });
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.LineSpeed", b =>
                {
                    ...
                    b.Property<int>("UnitsPerMin")
                        .HasColumnType("int");

                    b.HasKey("LineId", "SkuId");
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.MixerBackbone", b =>
                {
                    ...
                    b.Property<double>("BatchCycleTimeMin")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.ProductionScheduleItem", b =>
                {
                    ...
                    b.Property<double>("PlannedWeightKgr")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.SKU", b =>
                {
                    ...
                    b.Property<double>("grPerUnit")
                        .HasColumnType("float");

                    b.Property<double>("mLPerUnit")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.SKUComponent", b =>
                {
                    b.Property<Guid>("SkuId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEquipmentItem", b =>
                {
                    b.HasBaseType("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEngineeringItem");

                    b.Property<Guid?>("BasicEquipmentTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BasicEquipmentTemplateId");

                    b.HasIndex("EquipmentId");

                    b.ToTable("BasicEquipmentItems");
                });

            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicInstrumentItem", b =>
                {
                    b.HasBaseType("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEngineeringItem");

                    b.Property<Guid?>("BasicInstrumentTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BasicInstrumentTemplateId");

                    b.HasIndex("InstrumentId");

                    b.ToTable("BasicInstrumentItems");
                });

            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicPipeItem", b =>
                {
                    b.HasBaseType("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEngineeringItem");

                    b.Property<Guid?>("BasicFluidCodeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("BasicPipeTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BasicFluidCodeId");

                    b.HasIndex("BasicPipeTemplateId");

                    b.HasIndex("PipeId");

                    b.ToTable("BasicPipeItems");
                });

            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicValveItem", b =>
                {
                    b.HasBaseType("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEngineeringItem");

                    b.Property<Guid?>("BasicValveTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BasicValveTemplateId");

                    b.HasIndex("ValveId");

                    b.ToTable("BasicValveItems");
                });
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEngineeringItem", b =>
                {
                    b.HasOne("Server.Database.Entities.Project", "Project")
                        .WithMany("BasicEngineeringItems")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Nozzles.Nozzle", b =>
                {
                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEngineeringItem", "BasicEngineeringItemConnected")
                        .WithMany("ItemConnecteds")
                        .HasForeignKey("BasicEngineeringItemConnectedId")
                    ...
                    b.Navigation("BasicEngineeringItemConnected");
                });
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Pipings.IsometricItem", b =>
                {
                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicPipeItem", "BasicPipeItem")
                        .WithMany("IsometricItems")
                        .HasForeignKey("BasicPipeItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.LineProductionSchedule", b =>
                {
                    b.HasOne("Server.Database.FinishlinLines.ProductionLineAssignment", "Assignment")
                        .WithMany("Schedules")
            ...
            modelBuilder.Entity("Server.Database.FinishlinLines.ProductionScheduleItem", b =>
                {
                    b.HasOne("Server.Database.FinishlinLines.LineProductionSchedule", "Schedule")
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicEquipmentItem", b =>
                {
                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Equipments.EquipmentTemplate", "EquipmentTemplate")
                        .WithMany("BasicEquipments")
                        .HasForeignKey("BasicEquipmentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Equipments.Equipment", "Equipment")
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicInstrumentItem", b =>
                {
                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Instruments.InstrumentTemplate", "InstrumentTemplate")
                        .WithMany("BasicInstruments")
                        .HasForeignKey("BasicInstrumentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Instruments.Instrument", "Instrument")
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicPipeItem", b =>
                {
                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Pipings.EngineeringFluidCode", "FluidCode")
                        .WithMany("BasicPipeItems")
                        .HasForeignKey("BasicFluidCodeId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Pipings.PipeTemplate", "PipeTemplate")
                        .WithMany("BasicPipeItems")
                        .HasForeignKey("BasicPipeTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Pipings.Pipe", "Pipe")
                        .WithMany("PipeItems")
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.EngineeringItems.BasicValveItem", b =>
                {
                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Valves.ValveTemplate", "ValveTemplate")
                        .WithMany("BasicValves")
                        .HasForeignKey("BasicValveTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Valves.Valve", "Valve")
                        .WithMany("ValveItems")
            ...
            modelBuilder.Entity("Server.Database.Entities.Project", b =>
                {
                    ...
                    b.Navigation("BasicEngineeringItems");
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Pipings.Pipe", b =>
                {
                    b.Navigation("PipeItems");
                });

            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Valves.Valve", b =>
                {
                    b.Navigation("ValveItems");
                });
            ...
            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Equipments.EquipmentTemplate", b =>
                {
                    b.Navigation("BasicEquipments");
                });

            modelBuilder.Entity("Server.Database.Entities.BudgetItems.ProcessFlowDiagrams.Instruments.InstrumentTemplate", b =>
                {
                    b.Navigation("BasicInstruments");
                });
