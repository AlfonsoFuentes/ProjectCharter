...
namespace Server.EndPoint.MonitoringExpendingTools.Queries
{
    ...
    public static class BudgetItemMonitoringReportDtoExtensions
    {
        public static void GetCompleteData(this BudgetItemMonitoringReportDto dto, BudgetItem item, DateTime date, CultureInfo culture)
        {
        ...
        public static void GetNextYears(this BudgetItemMonitoringReportDto dto, BudgetItem budgetItem, DateTime currentDate, CultureInfo culture)
        {
            int currentYear = currentDate.Year;

            var OrdenesdeCompra = budgetItem.PurchaseOrders;
        ...
        static void GetPreviousYear(this BudgetItemMonitoringReportDto dto, BudgetItem budgetItem, DateTime currentDate, CultureInfo culture)
        {
            int currentYear = currentDate.Year;

            // Solo se consideran las órdenes recibidas en años anteriores
            var receivedPriorYears = budgetItem.PurchaseOrderItems
                .SelectMany(poi => poi.PurchaseOrderReceiveds)
