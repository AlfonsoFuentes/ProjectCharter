...
public partial class InstrumentTemplateTable
{
    ...
    public List<InstrumentTemplateResponse> OrderedFilteredItems => FilteredItems.OrderBy(x => x.VariableInstrument.Name).ThenBy(x => x.ModifierVariable.Name).ThenBy(x => x.BrandName).ToList();
