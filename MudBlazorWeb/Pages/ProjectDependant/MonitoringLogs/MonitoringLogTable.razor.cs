...
public partial class MonitoringLogTable
{
    ...
    async Task GetAll()
    {
        ...
        var result = await GenericService.GetAll<MonitoringLogResponseList, MonitoringLogGetAll>(new MonitoringLogGetAll()
        {
    ...
    HashSet<MonitoringLogResponse> SelecteItems = null!;
    public async Task DeleteGroup()
    {
        ...
        if (!result!.Canceled)
        {
            DeleteGroupMonitoringLogRequest request = new()
            {
    ...
    MonitoringLogResponse SelectedRow = null!;
    ...
    void RowClicked(MonitoringLogResponse item)
    {
