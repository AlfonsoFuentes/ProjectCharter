...
namespace MudBlazorWeb.Pages.ProjectDependant.ExpertJudgements;
public partial class ExpertJudgementDialog
{
    [CascadingParameter]
    ...
    [Parameter]
    public ExpertJudgementResponse Model { get; set; } = new();
