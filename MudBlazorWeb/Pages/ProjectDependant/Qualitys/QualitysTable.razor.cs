...
namespace MudBlazorWeb.Pages.ProjectDependant.Qualitys;
public partial class QualitysTable
{
    ...
    public Func<QualityResponse, bool> Criteria => x => x.Name.Contains(nameFilter, StringComparison.InvariantCultureIgnoreCase);
    public List<QualityResponse> FilteredItems => string.IsNullOrEmpty(nameFilter) ? Items :
    ...
    public async Task AddNew()
    {
        ...
        var dialog = await DialogService.ShowAsync<QualityDialog>("Quality", parameters, options);
    ...
    async Task Edit(QualityResponse response)
    {
    ...
    public async Task Delete(QualityResponse response)
    {
    ...
    HashSet<QualityResponse> SelecteItems = null!;
    public async Task DeleteGroup()
    {
        ...
        if (!result!.Canceled)
        {
            DeleteGroupQualityRequest request = new()
            {
    ...
    void RowClicked(QualityResponse item)
    {
