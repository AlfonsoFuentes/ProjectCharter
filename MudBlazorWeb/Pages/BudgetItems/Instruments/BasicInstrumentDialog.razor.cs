...
public partial class BasicInstrumentDialog
{
    [CascadingParameter]
    ...
    async Task GetInstrumentResponse()
    {
        ...
        {
            var result = await GenericService.GetById<BasicInstrumentResponse, GetBasicInstrumentByIdRequest>(
                  new GetBasicInstrumentByIdRequest() { Id = Model.Id });
    ...
    [Parameter]
    public BasicInstrumentResponse Model { get; set; } = new();
    [Parameter]
