...
public partial class BasicPipeDialog
{
    [CascadingParameter]
    ...
    [Parameter]
    public BasicPipeResponse Model { get; set; } = new();
    [Parameter]
    ...
    async Task GetPipeResponse()
    {
        ...
        {
            var result = await GenericService.GetById<BasicPipeResponse, GetBasicPipeByIdRequest>(
                  new GetBasicPipeByIdRequest() { Id = Model.Id });
