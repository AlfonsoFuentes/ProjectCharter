...
{
    public partial class BasicValveDialog
    {
        [CascadingParameter]
        ...
        async Task GetValveResponse()
        {
            ...
            {
                var result = await GenericService.GetById<BasicValveResponse, GetBasicValveByIdRequest>(
                      new GetBasicValveByIdRequest() { Id = Model.Id });
        ...
        [Parameter]
        public BasicValveResponse Model { get; set; } = new();
        [Parameter]
