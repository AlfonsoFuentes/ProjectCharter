...
public partial class NewBudgetItemsTable
{
    [Parameter]
    public ProjectResponse Project { get; set; } = null!;
    public BudgetItemResponseList Response { get; set; } = new();
    public List<BudgetItemResponse> Items => Response.OrderedItems;
    ...
    int nPages => FilteredItems.Count == 0 ? 1 : FilteredItems.Count + 1;
    ...
    HashSet<BudgetItemResponse> SelectedItems = null!;
    ...
    async Task ExportExcel()
    {
        BudgetItemExportGetAll request = new()
        {
            ...
            Items = Response.OrderedItems.GetExportedList(),
            Name = Project.Name,
        };
