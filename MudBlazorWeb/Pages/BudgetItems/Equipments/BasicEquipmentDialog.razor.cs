...
public partial class BasicEquipmentDialog
{
    [CascadingParameter]
    ...
    async Task GetEquipmentResponse()
    {
        ...
        {
            var result = await GenericService.GetById<BasicEquipmentResponse, GetBasicEquipmentByIdRequest>(
                  new GetBasicEquipmentByIdRequest() { Id = Model.Id });
    ...
    [Parameter]
    public BasicEquipmentResponse Model { get; set; } = new();
    [Parameter]
