...
public partial class SKUTable
{
    ...
    public Func<SKUResponse, bool> Criteria => x => x.Name.Contains(nameFilter, StringComparison.InvariantCultureIgnoreCase);
    public List<SKUResponse> FilteredItems => string.IsNullOrEmpty(nameFilter) ? Items :
    ...
    async Task Edit(SKUResponse response)
    {
    ...
    public async Task Delete(SKUResponse response)
    {
    ...
    HashSet<SKUResponse> SelecteItems = null!;
