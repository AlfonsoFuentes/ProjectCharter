...
{
    public class MainTaskDependencyMonitoringResponse
    {
        public int Order { get; set; } = 0;
        [JsonIgnore]
        public MonitoringGanttTaskResponse? MainTask { get; set; } = null!;
        public Guid MainTaskId { get; set; }
        [JsonIgnore]
        public MonitoringGanttTaskResponse? DependencyTask { get; set; } = null!;
        [JsonIgnore]
