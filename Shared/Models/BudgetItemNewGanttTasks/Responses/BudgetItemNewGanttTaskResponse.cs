...
namespace Shared.Models.BudgetItemNewGanttTasks.Responses
{
    public class BudgetItemNewGanttTaskResponse
    {
        ...
        public double BudgetUSD => BudgetItem == null ? 0 : BudgetItem.HasSubItems ? SelectedEngineeringItemsBudget == null ? 0 : SelectedEngineeringItemsBudget.BudgetUSD : BudgetItem.BudgetUSD;
        ...
        [JsonIgnore]
        public double TotalBudgetAssignedByOther => BudgetItem == null ? 0 : SelectedEngineeringItemsBudget == null ?
