...
namespace Web.Infrastructure.Validators.PurchaseOrders
{
    public class EditPurchaseOrderApprovedValidator : AbstractValidator<EditPurchaseApprovedOrderRequest>
    {
        ...
        bool ReviewNameExist(EditPurchaseApprovedOrderRequest request, string name/*, CancellationToken cancellationToken*/)
        {
        ...
        //bool ReviewPRExist(EditPurchaseApprovedOrderRequest request, string pr/*, CancellationToken cancellationToken*/)
        //{
        ...
        //    return !result;
        //}
        //bool ReviewPOExist(EditPurchaseApprovedOrderRequest request, string po/*, CancellationToken cancellationToken*/)
        //{
