...
namespace Web.Infrastructure.Validators.PurchaseOrders
{
    public class CreateSalaryPurchaseOrderValidator : AbstractValidator<CreateSalaryPurchaseOrderRequest>
    {
        ...
        bool ReviewNameExist(CreateSalaryPurchaseOrderRequest request, string name/*, CancellationToken cancellationToken*/)
        {
        ...
        bool ReviewPRExist(CreateSalaryPurchaseOrderRequest request, string pr/*, CancellationToken cancellationToken*/)
        {
