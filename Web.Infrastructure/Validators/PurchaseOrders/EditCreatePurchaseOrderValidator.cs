...
namespace Web.Infrastructure.Validators.PurchaseOrders
{
    public class EditCreatePurchaseOrderValidator : AbstractValidator<EditPurchaseOrderCreatedRequest>
    {
        ...
        bool ReviewNameExist(EditPurchaseOrderCreatedRequest request, string name/*, CancellationToken cancellationToken*/)
        {
        ...
        //bool ReviewPRExist(EditPurchaseOrderCreatedRequest request, string pr/*, CancellationToken cancellationToken*/)
        //{
        ...
        //    return !result;
        //}
        //bool ReviewPOExist(EditPurchaseOrderCreatedRequest request, string po/*, CancellationToken cancellationToken*/)
        //{
