...
namespace Web.Infrastructure.Validators.PurchaseOrders
{
    public class ApprovePurchaseOrderValidator : AbstractValidator<ApprovePurchaseOrderRequest>
    {
        ...
        bool ReviewNameExist(ApprovePurchaseOrderRequest request, string name/*, CancellationToken cancellationToken*/)
        {
        ...
        //bool ReviewPRExist(ApprovePurchaseOrderRequest request, string pr/*, CancellationToken cancellationToken*/)
        //{
        ...
        //    return !result;
        //}
        //bool ReviewPOExist(ApprovePurchaseOrderRequest request, string po/*, CancellationToken cancellationToken*/)
        //{
        ...
        //    //};
        //    //var result = await Service.Validate(validate);
        //    bool result = request.ProjectPurchaseOrders.Any(x => x.PONumber.Equals(po));
        //    return !result;
        //}
        ...
        //    //var result = await Service.Validate(validate);
        //    bool result = true;
        //    if (request.ProjectPurchaseOrders.Any(x => x.Name.Equals(name)))
        //    {
        //        result = false;
        //    }
