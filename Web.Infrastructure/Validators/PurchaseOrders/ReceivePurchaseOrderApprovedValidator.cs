...
namespace Web.Infrastructure.Validators.PurchaseOrders
{
    public class ReceivePurchaseOrderApprovedValidator : AbstractValidator<ReceivePurchaseOrderApprovedRequest>
    {
        ...
        bool ReviewNameExist(ReceivePurchaseOrderApprovedRequest request, string name/*, CancellationToken cancellationToken*/)
        {
        ...
        //bool ReviewPRExist(ReceivePurchaseOrderApprovedRequest request, string pr/*, CancellationToken cancellationToken*/)
        //{
        ...
        //    return !result;
        //}
        //bool ReviewPOExist(ReceivePurchaseOrderApprovedRequest request, string po/*, CancellationToken cancellationToken*/)
        //{
