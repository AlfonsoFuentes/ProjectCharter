...
namespace Web.Infrastructure.Validators.BudgetItems.BasicValves
{
    public class BasicValveValidator : AbstractValidator<BasicValveResponse>
    {
        private readonly IGenericService Service;

        public BasicValveValidator(IGenericService service)
        {
            Service = service;
        ...
        async Task<bool> ReviewIfNameExist(BasicValveResponse request, string name, CancellationToken cancellationToken)
        {
            ValidateBasicValveRequest validate = new()
            {
                Name = name,
                Id = request.Id,
        ...
        async Task<bool> ReviewIfTagExist(BasicValveResponse request, string tag, CancellationToken cancellationToken)
        {
            ValidateBasicValveTagRequest validate = new()
            {
        ...
        bool ReviewNozzles(BasicValveResponse request, List<NozzleResponse> nozzles)
        {
